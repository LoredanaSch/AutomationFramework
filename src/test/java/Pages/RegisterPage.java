...
public class RegisterPage extends BasePage {
  ...
  @FindBy(css = "select[ng-init*='monthbox']")
  ...
  public void RegisterProcess(RegisterObject registerObject){
    ...
    elementMethods.fillElement(PhoneNr, registerObject.getAddressValue());
  ...
  public void LanguagesProcess(String language){

    elementMethods.clickElement(LanguagesDropdown);
    for(int index=0; index<LanguagesOptions.size(); index++){
      if (LanguagesOptions.get(index).getText().equals("Arabic")) {
